...
export class VotingKeyLinkTransactionBuilder extends TransactionBuilder {
    ...
    public constructor(signature: SignatureDto,  signerPublicKey: KeyDto,  version: number,  network: NetworkTypeDto,  type: EntityTypeDto,  fee: AmountDto,  deadline: TimestampDto,  linkedPublicKey: VotingKeyDto,  linkAction: LinkActionDto) {
