...
export class SecretLockInfoBuilder {
    /** Sender public key. */
    ...
    public constructor(senderPublicKey: KeyDto,  mosaic: MosaicBuilder,  endHeight: HeightDto,  status: LockStatusDto,  hashAlgorithm: LockHashAlgorithmDto,  secret: Hash256Dto,  recipient: AddressDto) {
    ...
    public static loadFromBinary(payload: Uint8Array): SecretLockInfoBuilder {
        ...
        const recipient = AddressDto.loadFromBinary(Uint8Array.from(byteArray));
