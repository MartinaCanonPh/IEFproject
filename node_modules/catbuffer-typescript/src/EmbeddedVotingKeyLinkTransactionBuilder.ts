...
export class EmbeddedVotingKeyLinkTransactionBuilder extends EmbeddedTransactionBuilder {
    ...
    public constructor(signerPublicKey: KeyDto,  version: number,  network: NetworkTypeDto,  type: EntityTypeDto,  linkedPublicKey: VotingKeyDto,  linkAction: LinkActionDto) {
