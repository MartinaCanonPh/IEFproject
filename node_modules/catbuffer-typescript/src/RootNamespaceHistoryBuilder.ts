...
export class RootNamespaceHistoryBuilder {
    ...
    public constructor(id: NamespaceIdDto,  ownerPublicKey: KeyDto,  lifetime: NamespaceLifetimeBuilder,  rootAlias: NamespaceAliasTypeDto,  paths: NamespacePathBuilder[]) {
        this.id = id;
    ...
    public static loadFromBinary(payload: Uint8Array): RootNamespaceHistoryBuilder {
        ...
        const ownerPublicKey = KeyDto.loadFromBinary(Uint8Array.from(byteArray));
     ...
     */
    public getOwnerPublicKey(): KeyDto {
    ...
    public serialize(): Uint8Array {
        ...
        newArray = GeneratorUtils.concatTypedArrays(newArray, ownerPublicKeyBytes);
