...
export class BlockRoutesApi {
     ...
     */
    public async getBlockTransactions (height: string, pageSize?: number, id?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<TransactionInfoDTO>;  }> {
     ...
     * @param height Block height. 
     * @param limit Number of elements to be returned. The limit should be greater than or equal to \&quot;db.pageSizeMin\&quot; and not higher than \&quot;db.pageSizeMax\&quot;. The settings are adjustable via the configuration file (rest/resources/rest.json) per REST instance. 
     */
