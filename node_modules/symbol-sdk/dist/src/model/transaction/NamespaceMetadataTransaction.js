...
class NamespaceMetadataTransaction extends Transaction_1.Transaction {
     ...
     */
    static create(deadline, targetPublicKey, scopedMetadataKey, targetNamespaceId, valueSizeDelta, value, networkType, maxFee = new UInt64_1.UInt64([0, 0]), signature, signer) {
        return new NamespaceMetadataTransaction(networkType, TransactionVersion_1.TransactionVersion.NAMESPACE_METADATA, deadline, maxFee, targetPublicKey, scopedMetadataKey, targetNamespaceId, valueSizeDelta, value, signature, signer);
    }
    /**
    ...
    shouldNotifyAccount(address) {
        return super.isSigned(address) || Address_1.Address.createFromPublicKey(this.targetPublicKey, this.networkType).equals(address);
    }
}
