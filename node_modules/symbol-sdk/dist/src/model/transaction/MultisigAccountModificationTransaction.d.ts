...
export declare class MultisigAccountModificationTransaction extends Transaction {
     ...
     */
    static create(deadline: Deadline, minApprovalDelta: number, minRemovalDelta: number, publicKeyAdditions: PublicAccount[], publicKeyDeletions: PublicAccount[], networkType: NetworkType, maxFee?: UInt64, signature?: string, signer?: PublicAccount): MultisigAccountModificationTransaction;
    /**
     * @param networkType
     * @param version
     * @param deadline
