...
class MultisigAccountModificationTransaction extends Transaction_1.Transaction {
     ...
     */
    static create(deadline, minApprovalDelta, minRemovalDelta, publicKeyAdditions, publicKeyDeletions, networkType, maxFee = new UInt64_1.UInt64([0, 0]), signature, signer) {
        return new MultisigAccountModificationTransaction(networkType, TransactionVersion_1.TransactionVersion.MULTISIG_ACCOUNT_MODIFICATION, deadline, maxFee, minApprovalDelta, minRemovalDelta, publicKeyAdditions, publicKeyDeletions, signature, signer);
    }
    /**
    ...
    shouldNotifyAccount(address) {
        return (super.isSigned(address) ||
            this.publicKeyAdditions.find((_) => _.address.equals(address)) !== undefined ||
            this.publicKeyDeletions.find((_) => _.address.equals(address)) !== undefined);
    }
}
