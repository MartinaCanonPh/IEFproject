...
export declare class SecretLockTransaction extends Transaction {
     ...
     */
    static create(deadline: Deadline, mosaic: Mosaic, duration: UInt64, hashAlgorithm: LockHashAlgorithm, secret: string, recipientAddress: Address | NamespaceId, networkType: NetworkType, maxFee?: UInt64, signature?: string, signer?: PublicAccount): SecretLockTransaction;
    /**
     * @param networkType
     * @param version
     * @param deadline
