...
class MosaicMetadataTransaction extends Transaction_1.Transaction {
     ...
     */
    static create(deadline, targetPublicKey, scopedMetadataKey, targetMosaicId, valueSizeDelta, value, networkType, maxFee = new UInt64_1.UInt64([0, 0]), signature, signer) {
        return new MosaicMetadataTransaction(networkType, TransactionVersion_1.TransactionVersion.MOSAIC_METADATA, deadline, maxFee, targetPublicKey, scopedMetadataKey, targetMosaicId, valueSizeDelta, value, signature, signer);
    }
    /**
