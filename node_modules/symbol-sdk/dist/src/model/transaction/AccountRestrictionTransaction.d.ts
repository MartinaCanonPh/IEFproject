...
export declare class AccountRestrictionTransaction {
     ...
     */
    static createAddressRestrictionModificationTransaction(deadline: Deadline, restrictionFlags: AddressRestrictionFlag, restrictionAdditions: (Address | NamespaceId)[], restrictionDeletions: (Address | NamespaceId)[], networkType: NetworkType, maxFee?: UInt64, signature?: string, signer?: PublicAccount): AccountAddressRestrictionTransaction;
    /**
     ...
     */
    static createMosaicRestrictionModificationTransaction(deadline: Deadline, restrictionFlags: MosaicRestrictionFlag, restrictionAdditions: (MosaicId | NamespaceId)[], restrictionDeletions: (MosaicId | NamespaceId)[], networkType: NetworkType, maxFee?: UInt64, signature?: string, signer?: PublicAccount): AccountMosaicRestrictionTransaction;
    /**
