...
export declare class MosaicMetadataTransaction extends Transaction {
     ...
     */
    static create(deadline: Deadline, targetPublicKey: string, scopedMetadataKey: UInt64, targetMosaicId: MosaicId | NamespaceId, valueSizeDelta: number, value: string, networkType: NetworkType, maxFee?: UInt64, signature?: string, signer?: PublicAccount): MosaicMetadataTransaction;
    /**
     * @param networkType
     * @param version
     * @param deadline
