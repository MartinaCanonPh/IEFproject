...
class AccountAddressRestrictionTransaction extends Transaction_1.Transaction {
    ...
    shouldNotifyAccount(address, alias) {
        return (super.isSigned(address) ||
            ...
            this.restrictionAdditions.find((_) => alias.find((name) => name.equals(_) !== undefined)) !== undefined ||
            this.restrictionDeletions.find((_) => alias.find((name) => name.equals(_) !== undefined)) !== undefined);
    }
}
