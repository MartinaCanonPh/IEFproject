...
export declare class MosaicAddressRestrictionTransaction extends Transaction {
     ...
     */
    static create(deadline: Deadline, mosaicId: MosaicId | NamespaceId, restrictionKey: UInt64, targetAddress: Address | NamespaceId, newRestrictionValue: UInt64, networkType: NetworkType, previousRestrictionValue?: UInt64, maxFee?: UInt64, signature?: string, signer?: PublicAccount): MosaicAddressRestrictionTransaction;
    /**
     * @param networkType
     * @param version
     * @param deadline
