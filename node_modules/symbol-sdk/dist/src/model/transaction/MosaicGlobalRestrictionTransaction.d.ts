...
export declare class MosaicGlobalRestrictionTransaction extends Transaction {
     ...
     */
    static create(deadline: Deadline, mosaicId: MosaicId | NamespaceId, restrictionKey: UInt64, previousRestrictionValue: UInt64, previousRestrictionType: MosaicRestrictionType, newRestrictionValue: UInt64, newRestrictionType: MosaicRestrictionType, networkType: NetworkType, referenceMosaicId?: MosaicId | NamespaceId, maxFee?: UInt64, signature?: string, signer?: PublicAccount): MosaicGlobalRestrictionTransaction;
    /**
     * @param networkType - The network type
