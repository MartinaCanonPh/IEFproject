...
class AccountMetadataTransaction extends Transaction_1.Transaction {
     ...
     */
    static create(deadline, targetPublicKey, scopedMetadataKey, valueSizeDelta, value, networkType, maxFee = new UInt64_1.UInt64([0, 0]), signature, signer) {
        return new AccountMetadataTransaction(networkType, TransactionVersion_1.TransactionVersion.ACCOUNT_METADATA, deadline, maxFee, targetPublicKey, scopedMetadataKey, valueSizeDelta, value, signature, signer);
    }
    /**
