    ...
    static extractAccountRestrictionFromDto(accountRestrictions) {
        return new AccountRestrictionsInfo_1.AccountRestrictionsInfo(accountRestrictions.meta, new AccountRestrictions_1.AccountRestrictions(Address_1.Address.createFromEncoded(accountRestrictions.accountRestrictions.address), accountRestrictions.accountRestrictions.restrictions.map((prop) => {
            switch (prop.restrictionFlags) {
                case model_1.AddressRestrictionFlag.AllowIncomingAddress:
                case model_1.AddressRestrictionFlag.BlockIncomingAddress:
                case model_1.AddressRestrictionFlag.AllowOutgoingAddress:
                case model_1.AddressRestrictionFlag.BlockOutgoingAddress:
                ...
                case model_1.MosaicRestrictionFlag.AllowMosaic:
                case model_1.MosaicRestrictionFlag.BlockMosaic:
                ...
                case model_1.OperationRestrictionFlag.AllowOutgoingTransactionType:
                case model_1.OperationRestrictionFlag.BlockOutgoingTransactionType:
